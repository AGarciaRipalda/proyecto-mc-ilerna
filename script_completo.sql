...
CAMBIOS EN VERSIÓN 2.0:
  + Agregada tabla INGREDIENTE (4 campos)
  + Agregada tabla PRODUCTO_INGREDIENTE (2 campos - PK compuesta)
  - Eliminado campo Ingredientes de tabla PRODUCTO
  ✓ Sistema ahora cumple estrictamente con 3FN
  ✓ Mejor gestión de alérgenos
  ✓ Consultas más eficientes para filtrar por ingredientes
*/
